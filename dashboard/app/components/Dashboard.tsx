            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  ...
                  <ColHeader label="Actual"   tip="Observed high temperature. Sourced from the NWS Climatological Daily Report (CLI) — Kalshi's settlement source. Falls back to Open-Meteo ERA5 archive for trades older than ~14 days when CLI products expire from the NWS API." sortKey="actual_high_f" sort={settledSort} onSort={k => setSettledSort(toggleSort(settledSort, k))} />
