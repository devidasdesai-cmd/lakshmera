            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  ...
                  <ColHeader label="Actual"   tip="Observed high from Open-Meteo (ERA5 archive at city coords). ⚠ Kalshi settles on NWS Daily Climate Reports, which can differ by 1-5°F. The bot's WIN/LOSS comes from Kalshi (authoritative); this column is informational reference." sortKey="actual_high_f" sort={settledSort} onSort={k => setSettledSort(toggleSort(settledSort, k))} />
